...
namespace api {
    ...
    public:
        METHOD_LIST_BEGIN
            ADD_METHOD_TO(User::login, "/api/user/login", Options, Post, "NotNullFilter");
            ADD_METHOD_TO(User::addUser, "/api/user/addUser", Options, Put, "NotNullFilter", "LoginFilter");
            ADD_METHOD_TO(User::getUser, "/api/user/getUser", Options, Get, "LoginFilter");
            ADD_METHOD_TO(User::delUser, "/api/user/delUser", Options, Delete, "NotNullFilter", "LoginFilter");
            ADD_METHOD_TO(User::editUser, "/api/user/editUser", Options, Post, "NotNullFilter", "LoginFilter");
            ADD_METHOD_TO(User::modifyPassword, "/api/user/modifyPassword", Options, Post, "NotNullFilter",
                          "LoginFilter");
        METHOD_LIST_END
